...
public enum EngineConfigurationErrorType {
    OTHER(null),
    ...
    INVALID_CHANNEL_ID_PROPERTY("Invalid channel id property."),
    INVALID_CHANNEL_PROPERTY("Invalid channel property."),
    ...
    private EngineConfigurationErrorType(String error) {
        this.error = error;
    }
