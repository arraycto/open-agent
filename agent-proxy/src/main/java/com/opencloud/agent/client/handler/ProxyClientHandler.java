...
import com.opencloud.agent.client.executor.ExecutorResponseCenter;
...
public class ProxyClientHandler extends AbstractClientHandler {

    private SocketAddress remotePeer;
    private RpcProtocol rpcProtocol;
    private ExecutorResponseCenter executorCenter;

    public ProxyClientHandler(ThreadPoolExecutor threadPoolExecutor, Integer retryTime) {
        executorCenter = new ExecutorResponseCenter(threadPoolExecutor, retryTime);
    }
